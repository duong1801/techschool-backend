                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input name="username" type="text" class="form-control" id="exampleInputFullName"
                                placeholder="Họ và tên" value="{{ old('username') }}">
                            @error('username')
                        ...
                        <div class="form-group">
                            ...
                            <input name="name" type="text" class="form-control" id="exampleInputName"
                                placeholder="Tên đăng nhập" value="{{ old('name') }}">
                            @error('name')
                                <div class="alert alert-danger my-2">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            <label>Địa chỉ</label>
                            <textarea class="form-control" name="address" rows="3" placeholder="Nhập địa chỉ">{{ old('address') }}</textarea>
                            @error('address')
                                <div class="alert alert-danger my-2">{{ $message }}</div>
                            @enderror
                        </div>
